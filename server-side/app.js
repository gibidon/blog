...
const { addComment, deleteComment } = require("./constrollers/comment")
...
app.get("/posts/:id", async (req, res) => {
	console.log("getting post in express!")
	const post = await getPost(req.params.id)
	console.log("post extracted from db: ", post)
